...
T_C = readtable('Figure S11.xlsx','Sheet','S11C');

subplot(1,2,1);
box_plot_gen(T_C.NPTX2_NeuN, T_C.Genotype, T_C.Depth,0)
box off
ylim([0 3])
xticklabels({'L2/3','L5/6'})
ylabel({'NPTX2+/NeuN+','colocalization intensity'})
%lgd = legend('WT','APP','Location','southeast');

T_D = readtable('Figure S11.xlsx','Sheet','S11D');
